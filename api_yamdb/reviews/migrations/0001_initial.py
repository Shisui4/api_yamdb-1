# Generated by Django 2.2.16 on 2021-12-06 13:25
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(blank=True, choices=[('moderator', 'moderator'), ('admin', 'admin'), ('user', 'user')], default='user', max_length=20, null=True, verbose_name='Статус пользователя')),
